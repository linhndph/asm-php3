...
@section('content')
    <div class="pc-content">
        <!-- [ breadcrumb ] start -->
        @include('admins.components.head',['pageName' => 'Quản trị danh mục'])
        <!-- [ breadcrumb ] end -->
        <!-- [ Main Content ] start -->
        <div class="row">
            <div class="col-12">
                <div class="card table-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
                        ...
                        <button class="btn btn-sm btn-link-primary"><a href="{{ route('admin.create') }}">Thêm mới</a></button>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-hover" id="pc-dt-simple">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.edit',$item->id)}}" class="avtar avtar-xs btn-link-secondary">
                                            <i class="ti ti-edit f-20"></i>
                                        </a>
                                     <form action="{{route('admin.destroy',$item->id)}}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                      <button type="submit" class="btn btn-sm btn-link-secondary mb-2"><i class="ti ti-trash f-20"></i></button>
