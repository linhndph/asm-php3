<script src="{{asset('../asset/js/plugins/apexcharts.min.js')}}"></script>
<script src="{{asset('../asset/js/pages/dashboard-finance.js')}}"></script>
...
<script src="{{asset('../asset/js/pcoded.js')}}"></script>
